...
export const deleteSnippet = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (snippet.userId !== identity.subject) {
      throw new ConvexError("User not authorized to delete snippet");
    }

    // delete all comments and stars associated with the snippet
...
// mutation to create a new comment for a snippet
...
// query to get all comments for a snippet
...
// query to check if a snippet is starred
...
// mutation to get the no of stars for a snippet
...
// query to get all starred snippets for a user
